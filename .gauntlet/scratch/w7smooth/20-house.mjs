...
const P=(f)=>decode(`.gauntlet/waves/core-after-docks/7/${f}`)
...
show('tool card interior (surface)', C, 400, 180)
show('tool card border', C, 400, 169)
show('disclosure row band interior (NEW 28px row)', C, 400, 246)
