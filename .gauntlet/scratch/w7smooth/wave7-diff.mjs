...
const A_DIR = '.gauntlet/waves/core-after-docks/6'
const B_DIR = '.gauntlet/waves/core-after-docks/7'
const FILES = [
  'welcome.png', 'welcome-min-window.png', 'titlebar.png', 'sidebar.png', 'chat.png',
  'input-bar.png', 'window-welcome.png', 'window-session.png',
  'agents-dock.png', 'appearance-dock.png', 'commands-dock.png', 'window-session-short.png',
]
