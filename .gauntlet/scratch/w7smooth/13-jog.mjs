// (d) THE -5px JOG AS A PURE CONTROL. Same definition wave 5 and wave 6 used.
...
for (const [tag,path,tBand,cBand] of [
  ['wave6 SHORT','.gauntlet/waves/core-after-docks/6/window-session-short.png',null,null],
  ['wave7 SHORT','.gauntlet/waves/core-after-docks/7/window-session-short.png',null,null],
  ['wave6 window-session','.gauntlet/waves/core-after-docks/6/window-session.png',[60,760],[775,899]],
  ['wave7 window-session','.gauntlet/waves/core-after-docks/7/window-session.png',[60,760],[775,899]],
]) {
  const I=decode(path)
